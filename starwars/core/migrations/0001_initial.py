    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeworld', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Planet')),
                ('people', models.ManyToManyField(related_name='species', to='core.People')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='people',
            name='homeworld',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='residents', to='core.Planet'),
        ),
        migrations.CreateModel(
            name='Hero',
            fields=[
                ...
                ('edited', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('homeworld', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='heroes', to='core.Planet')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pilots', models.ManyToManyField(blank=True, related_name='vehicles', to='core.People')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pilots', models.ManyToManyField(blank=True, related_name='starships', to='core.People')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('characters', models.ManyToManyField(blank=True, related_name='films', to='core.People')),
